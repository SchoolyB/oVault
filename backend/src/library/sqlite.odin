...
This file and all its content comes DIRECTLY from https://github.com/saenai255/odin-sqlite3
The content is unmodified and is up to date with the upstream repository as of Oct 11th 2025.
Any date after that could mean the upstream repo has been modified so be aware.

At the time of writting this notice on Oct 11th 2025 the 'odin-sqlite3' codebase is licensed under MIT
That can be found here: https://github.com/saenai255/odin-sqlite3/blob/master/LICENSE
*/
